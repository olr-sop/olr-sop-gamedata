...
// #define USE_SUNMASK                		//- shader defined //тени от облаков :/
//#define DBG_TMAPPING
//////////////////////////////////////////////////////////////////////////////////////////
#ifndef SMAP_size
#define SMAP_size        4096
#endif
#define PARALLAX_H 0.04 //0.02
...
//////////////////////////////////////////////////////////////////////////////////////////
// Defines                                		//
#define def_gloss       half(24.f /255.f)
#define def_aref        half(200.f/255.f)
#define def_dbumph      half(0.5f)
#define def_virtualh    half(.00f)	//(.05f)              // 5cm
...
//ПЕРЕНЕСЕНО В shared\common.h  (нужно для particles.ps/particles.vs)
//	contrast function
