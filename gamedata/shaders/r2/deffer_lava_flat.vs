//Ёто deffer_base_flat.vs, доработанный дл€ корректного отображени€ лавы [ScaV]
...
p_flat 	main	( v_static I )
{
	...
	O.position	= float4	(Pe, 		L_material.x*L_material.y	); //«десь устран€ем ненужное затенение полигонов [ScaV]
