//local t_base                = "water\\water_pool1"
//local tex_base              = "water\\water_pool1"
local tex_base                = "water\\water_water"
local tex_nmap                = "water\\water_normal_move"
local tex_dist                = "water\\water_dudv_move"
...
function normal(shader, t_base, t_second, t_detail)
	shader:begin 	("waternew","waternew")
        : sorting	(2, false)
//      : blend         (true,blend.srcalpha,blend.invsrcalpha)
        : blend         (true,blend.srcalpha,blend.srcalpha)
        : zb		(true,false)
        : distort	(true)
        : fog           (false)
